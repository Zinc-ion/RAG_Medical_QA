...
async def _get_node_data(
    ...
    def rerank(data):
        ...
        reranker = FlagReranker('/Users/xiehuaibing/Documents/Kaggle合集/DSAA610/lightrag4teach/LightRAG/lightragPkg/BAAI/bge-reranker-v2-m3', use_fp16=True)
        query=query_origin
...
async def _get_edge_data(
    ...
    def rerank(data):
        ...
        def get_top_k_results(data, query, reranker, k=10):
            ...
            return results_sorted
        from FlagEmbedding import FlagReranker
        reranker = FlagReranker('/Users/xiehuaibing/Documents/Kaggle合集/DSAA610/MedRAG/LightRAG/lightragPkg/BAAI/bge-reranker-v2-m3', use_fp16=True)
        query=query_origin
        top_k_results = get_top_k_results(data, query, reranker, k=10)
        return top_k_results
